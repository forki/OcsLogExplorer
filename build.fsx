...
let authors = [ "MarcinJuraszek" ]

// Tags for your project (for NuGet package)
let tags = ""

// File system information
let solutionFile  = "OcsLogExplorer.sln"
...
Target "CopyWebContent" (fun _ ->
    CopyDir "bin/content" "src/OcsLogExplorer.Web" (fun _ -> true)
)
