...
let website = "/OcsLogExplorer"

let githubLink = "http://github.com/Update GitHome in build.fsx/OcsLogExplorer"

// Specify more information about your project
let info =
  [ "project-name", "OcsLogExplorer"
    "project-author", "MarcinJuraszek"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/OcsLogExplorer" ]
